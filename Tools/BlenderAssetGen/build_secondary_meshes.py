...
ENGINE_METAL = mat("EngineBay_Metal", (0.22, 0.22, 0.24), metallic=0.7, roughness=0.4)
ENGINE_BLOCK = mat("EngineBay_Block", (0.12, 0.12, 0.13), metallic=0.3, roughness=0.5)
...
TERRAIN_DIRT = mat("Terrain_Dirt", (0.32, 0.24, 0.16), roughness=0.9)
TERRAIN_ROAD = mat("Terrain_Road", (0.1, 0.1, 0.1), roughness=0.8)
...
RAIDER_BODY = mat("Raider_Body", (0.28, 0.05, 0.03), roughness=0.7)
RAIDER_ARMOR = mat("Raider_Armor", (0.15, 0.15, 0.15), metallic=0.5, roughness=0.6)
RAIDER_TIRE = mat("Raider_Tire", (0.02, 0.02, 0.02), roughness=1.0)

raider_objs = [
    cube("raider_chassis", (4.6, 1.9, 0.5), (0, 0, 0.55), RAIDER_BODY),
    cube("raider_cabin", (2.0, 1.7, 0.7), (0.3, 0, 1.05), RAIDER_BODY),
...
dash_objs = [
    cube("dashboard_panel", (1.1, 0.08, 0.3), (0, 0, 0), DASH_PLASTIC),
