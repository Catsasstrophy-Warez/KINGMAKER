...
[`README.md`](../README.md) for the live status summary). Revs 3–9 are
purely historical (superseded by the Rev10 docs below) and live in
[`archive/`](archive/) to keep this index focused on current state.

| Rev | Doc | Summary |
|---|---|---|
| 3 | [REV3_IMPLEMENTATION_REPORT.md](archive/REV3_IMPLEMENTATION_REPORT.md) | Early simulation/architecture pass |
| 4 | [REV4_IMPLEMENTATION_REPORT.md](archive/REV4_IMPLEMENTATION_REPORT.md) | Vehicle/build system expansion |
| 5 | [REV5_IMPLEMENTATION_REPORT.md](archive/REV5_IMPLEMENTATION_REPORT.md) | World/settlement systems |
| 6 | [REV6_IMPLEMENTATION_REPORT.md](archive/REV6_IMPLEMENTATION_REPORT.md) | First playable foundation — RealityKit garage/highway/Paradise blockouts, isometric camera, HUD, streaming cells |
| 7 | [REV7_IMPLEMENTATION_REPORT.md](archive/REV7_IMPLEMENTATION_REPORT.md) | Blackridge playable app — Xcode app handoff, SwiftUI/RealityKit host, touch controls, HUD, audio/FX state, trading |
| 8 | [REV8_IMPLEMENTATION_REPORT.md](archive/REV8_IMPLEMENTATION_REPORT.md) | Original-vision audit + living world gameplay — locations, scavenging, perks/equipment/injuries, combat, negotiation, recruitment, radio, vehicle entry/exit |
| 9 | [REV9_IMPLEMENTATION_REPORT.md](archive/REV9_IMPLEMENTATION_REPORT.md) | Production gameplay integration (44/44 Swift tests passing at this point) |
