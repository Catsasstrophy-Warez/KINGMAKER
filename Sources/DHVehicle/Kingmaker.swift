import Foundation
import DHCore
public enum ComponentCondition: String, Codable, Sendable { case missing, seized, failed, poor, serviceable, good, restored }
public enum KingmakerSystem: String, Codable, CaseIterable, Sendable { case engine, induction, cooling, lubrication, fuel, ignition, electrical, transmission, driveline, differential, suspension, steering, brakes, wheelsTires, chassis, body, aero, lighting, armor, survival }
