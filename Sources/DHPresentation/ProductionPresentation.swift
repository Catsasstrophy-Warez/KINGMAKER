...
public struct DHProductionHUD: Sendable, Codable, Equatable {
    public var health: Double = 1
    public var fuel: Double = 1
    public var temperature: Double = 0
    public var radioSignal: Double = 0
    public var prompt: DHInteractionPrompt?
}
